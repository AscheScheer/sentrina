                ...
                <div class="card shadow-sm">
                    <div class="card-body p-3">
                        <div class="row g-3 align-items-end">
                            <!-- Quick Name Search -->
                            <div class="col-md-4">
                                <form action="{{ route('admin.laporan.index') }}" method="GET" class="d-inline w-100" id="searchForm">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="btn-group w-100" role="group">
                                    ...
                                    <a href="{{ route('admin.export.form') }}" class="btn btn-outline-success btn-sm">
                                        📄 Export
                                    </a>
                                </div>
                            </div>
