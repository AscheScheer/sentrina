<x-app-layout>
    <div class="max-w-xl mx-auto bg-white p-5 rounded shadow">
        <h2 class="text-2xl font-bold mb-4 text-center">Edit Kelompok</h2>
        ...
        <form action="{{ route('admin.kelompoks.update', $kelompok->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama" id="nama" value="{{ old('nama', $kelompok->nama) }}"
