...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    ...
    <button onclick="document.getElementById('loginModal').classList.remove('hidden')"
        class="bg-green-400 text-white font-bold py-2 px-6 rounded shadow hover:bg-green-500 transition">
        Pilih Login
    </button>

    <!-- Modal -->
    <div id="loginModal" class="hidden fixed inset-0 flex items-center justify-center z-50 modal-bg">
        <div class="modal-box p-6 relative">
            <!-- Close Button -->
            <button onclick="document.getElementById('loginModal').classList.add('hidden')"
                class="absolute top-2 right-2 text-gray-700 hover:text-gray-900 text-lg">&times;</button>

            <h2 class="text-xl font-semibold text-center text-green-800 mb-4">Pilih Tipe Login</h2>

            <a href="/login">
                <button class="modal-button">User Login</button>
            </a>
            <a href="/staff/login">
                <button class="modal-button">Staff Login</button>
            </a>
            <a href="/admin/login">
                <button class="modal-button">Admin Login</button>
            </a>
        </div>
    </div>
    @if (Route::has('login'))
